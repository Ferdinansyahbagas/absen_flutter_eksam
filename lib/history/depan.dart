...
// Function to show the bottom sheet with attendance history
    ...
    showModalBottomSheet(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
            top: Radius.circular(16.0)), //tamah background putih
      ),
                                ...
                                PopupMenuItem<int>(
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        child: Text(
                                          'in the last 10 days', // cara supaya no nya warna ornge
                                          style: TextStyle(
                                            color: Colors.black,
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              trailing: ElevatedButton(
                                onPressed: () {
                                  // Open AttendanceDetailModal as a pull-up modal
                                  showModalBottomSheet(
                                    context: context,
                                    isScrollControlled: true,
                                    shape: RoundedRectangleBorder(
                                    ...
                                    builder: (BuildContext context) {
                                      return AttendanceDetailModal(
                                        ...
                                        clockIn: historyItem['starttime'],
                                        clockOut: historyItem['endtime'],
                                        workDuration: historyItem['duration'],
  ...
  Widget _buildCard({
    ...
    return Container(
      height: 100.0, // Disesuaikan dengan gambar
